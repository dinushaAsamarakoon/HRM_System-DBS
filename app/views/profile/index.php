        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end  " id="navbarScroll"
                ...
                <ul class="nav  " id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active " id="pills-dashboard-tab" data-toggle="pill"
                           href="<?= SROOT ?><?= Session::get('dashboard') ?>" role="tab" aria-controls="pills-logout"
                           aria-selected="true" style="color: #0c63e4;font-size: 20px;">Dashboard</a>
                    </li>
                </ul>
...
//                dnd($p);?>
<form action="" <?= SROOT ?>HRManagerFunctionHandler
/editEmployee/<?= $p['id'] ?>" method="Post">
                ...
                <form>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Username</label><input type="text"
                                                                                           ...
                                                                                           disabled></div>
                        <div class="col-md-6"><label class="labels">Gender</label><input type="text"
                                                                                         class="form-control"
                                                                                         id="gender"
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Date of Birth</label><input type="text"
                                                                                                ...
                                                                                                disabled></div>
                        <div class="col-md-6"><label class="labels">Marital status</label><input type="text"
                                                                                                 class="form-control"
                                                                                                 id="martial"
                                                                                                 value="<?php echo $p["marital_status"]; ?>"
                                                                                                 disabled></div>
                    </div>
                    ...
                    <div class="row mt-2 ">
                        <div class="col-md-6"><label class="labels">Mobile Number</label><input type="text"
                                                                                                ...
                                                                                                disabled></div>
                        <div class="col-md-6"><label class="labels">Job title</label><input type="text"
                                                                                            class="form-control"
                                                                                            id="job_title"
                                                                                            value="<?php echo $p['job_title'] ?>"
                                                                                            disabled></div>

                    </div>
                    <div class="row mt-2 ">
                        <div class="col-md-6"><label class="labels">Pay grade</label><input type="text"
                                                                                            class="form-control"
                                                                                            id="pay_grade"
                                                                                            value="<?php echo $p['pay_grade'] ?>"
                                                                                            disabled></div>
                        <div class="col-md-6"><label class="labels">Employment status id</label><input type="text"
                                                                                                       class="form-control"
                                                                                                       id="emp_status"
                                                                                                       value="<?php echo $p["emp_status"]; ?>"
                                                                                                       disabled>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">National identity card number</label><input
                                    type="text" class="form-control" id="id_num" value="<?php echo $p['NIC'] ?>"
                                    disabled></div>
                        <div class="col-md-12"><label class="labels">Home address</label><input type="text"
                                                                                                class="form-control"
                                                                                                id="address"
                        ...
                        <div class="col-md-12"><label class="labels">Email Address</label><input type="text"
                                                                                                 ...
                                                                                                 disabled></div>
                        <div class="col-md-12"><label class="labels">Qualification</label><textarea type="text"
                                                                                                    class="form-control"
                                                                                                    id="qualification"
                                                                                                    placeholder=""
                                                                                                    disabled
                                                                                                    style="place"><?php echo $p["qualification"]; ?></textarea>
                        </div>
                    </div>
