            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2" >
                    <div class="col-md-12"><label class="labels">Home address</label><input type="text" class="form-control"  value="<?php echo $p['address'] ?>" disabled></div>
                     ...
                     <div class="col-md-12"><label class="labels">Qualification</label><textarea type="text" class="form-control" disabled><?php echo $p['qualification'] ?></textarea></div>
                ...
                <div class="row mt-2 ">
                    ...
                    <div class="col-md-6"><label class="labels">Employment status</label><input type="text" class="form-control"  value="<?php echo $p['emp_status_id'] ?>" disabled></div>
                </div>
            </div>
