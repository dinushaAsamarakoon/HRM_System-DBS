            ...
            <div class="col-sm-12 ">
                <div class="card">
                    <div class="card-body shadow  px-lg-5">
                        ...
                        <a href="../register/addEmployee.php" class="btn btn-primary justify-content-center"><i class="fa-solid fa-user-plus"></i> Add Employee</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card h-100">
                    <div class="card-body shadow px-lg-5">
                        ...
                        <a href="#" class="btn btn-primary"><i class="fa-light fa-file-circle-info"></i> View Details</a>
                    </div>
                </div>
            </div>
        </div>
