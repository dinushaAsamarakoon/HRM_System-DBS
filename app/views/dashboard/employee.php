        ...
        <div class="row pt-lg-3">
            <div class="col-sm-12">
                <div class="card h-100">
                    <div class="card-body shadow px-lg-5">
                        <h5 class="card-title">View leave details</h5>
                        <p class="card-text">You can view the all of your leave details from the system</p>
                        <a href="#" class="btn btn-primary"><i class="fa-light fa-file-circle-info"></i> View leave</a>
                    </div>
                </div>
            </div>
        </div>
